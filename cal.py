...
Substraction=Button(cal,padx=16,bd=8, fg="black",font=('arial', 20,'bold'),
           text="̶-",command=lambda:btnClick("-")).grid(row=2,column=3)
...
Point=Button(cal,padx=16,bd=8, fg="black",font=('arial', 20,'bold'),
           text=".",command=lambda:btnClick(".")).grid(row=4,column=2)

Equalsto=Button(cal,padx=16,bd=8, fg="black",font=('arial', 20,'bold'),
